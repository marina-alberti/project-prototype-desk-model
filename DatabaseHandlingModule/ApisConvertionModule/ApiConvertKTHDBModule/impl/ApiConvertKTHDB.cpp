...
the object instance of class "SceneInformation", which is passed by reference
...
void ApiConvertKTHDB::parseObject(boost::property_tree::ptree & parent, SceneInformation & mySceneInformation) {
  ...
  // TODO: modify for the new large dataset ("Monitor", "Monitor_1") // // TODO

  newObject.setObjectNameLargeDataset(parent.get<std::string>(TAG_NAME));
